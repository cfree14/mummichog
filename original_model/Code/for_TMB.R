...
#compile('original_model/Code/DM_const_sig.cpp')
try(dyn.unload(dynlib("original_model/Code/DM_MM_sig")))
compile('original_model/Code/DM_MM_sig.cpp')

#dyn.load(dynlib("DM_const_sig"))
dyn.load(dynlib("original_model/Code/DM_MM_sig"))
