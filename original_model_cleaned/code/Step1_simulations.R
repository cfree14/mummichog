...
# Read data
dat <- read.data(file.path(datadir, 'crk2.dat'))
...
# Loop through reps and simulate
for(ii in 1:nreps) {
...
# Loop through models and do something
for(sim.mod in 1:nmods) {
